...
Sprite::Sprite(const std::string& name, std::shared_ptr<GameObject> gameObject,
	...
	, m_size(size)
	, m_subTextureName(initialSubTexture)
	, m_vertexCoordsBuffer(ResourceManager::getResource<VertexBuffer>("TestVertexBuffer"))
	, m_IndexBuffer(ResourceManager::getResource<IndexBuffer>("TestIndexBuffer"))
...
void Sprite::setSize(const glm::vec2& size)
{
	...
	model = glm::translate(buf, glm::vec3(m_position, 0.f));
