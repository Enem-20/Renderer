...
RenderPass::RenderPass(const std::string& name, std::shared_ptr<PhysicalDevice> physicalDevice, std::shared_ptr<LogicalDevice> logicalDevice, std::shared_ptr<SwapChain> swapchain)
	: ResourceBase(name)
...
RenderPass::~RenderPass() {
	vkDestroyRenderPass(logicalDevice.lock()->getRaw(), renderPass, nullptr);
}
